...
function About() {
    return (
        <section id='about'>
            ...
            <p>Hi, I’m Jenn! I’m currently based in Vancouver, Canada and recently completed a masters degree
                 at <a href="https://omscs.gatech.edu/">Georgia Tech</a> in computer science, with a focus on machine learning.</p>
            ...
            <p>I love thinking about how to apply technology to pressing global issues or ways to improve life around us, which is why the projects you will find here are often inspired by this, 
                as well as tools I am currently learning. Some themes that tend to spark my interest are improving the global financial system for future generations, climate change and safe deployment of artificial intelligence.</p>
